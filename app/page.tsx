...
const initialLands: Land[] = [
  {
    id: 1,
    title: "2 Acre Agricultural Land",
  ...
  {
    id: 2,
    title: "5 Acre Farmland with Water Access",
  ...
  {
    id: 3,
    title: "3 Acre Plot Near Highway",
  ...
  {
    id: 4,
    title: "1.5 Acre Residential Plot",
...
export default function HomePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Basic validation
    const requiredFields = ['fullName', 'email', 'phoneNumber', 'propertyLocation', 'propertyType', 'propertySize', 'expectedPrice'];
    const missingFields = requiredFields.filter(field => !formData[field as keyof ListPropertyFormData]);
    ...
    try {
      // Create a copy without the FileList objects and convert files to array
      ...
      setIsModalOpen(false);
      setFormData(initialFormData);
      alert('Thank you! We have received your details. Our team will verify your documents within 24 hours and contact you.');
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Upload documents like deed, survey map, etc. (Multiple files allowed)
                </p>
              </div>
              ...
              <div className="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <button
                  ...
                  className="px-8 py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-semibold rounded-lg transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg disabled:transform-none disabled:shadow-none"
                >
